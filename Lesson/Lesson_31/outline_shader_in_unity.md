...
Shader"ShaderDev/14OutlineShader"
{
    ...
    Properties
    {
        ...
        _OutlineWidth("Outline Width", float) = 0.05    // 控制描边宽度
        _OutlineColor("Outline Color", Color) = (1, 1, 1, 1)    // 控制描边颜色
    }
    ...
    {   
        ...
        // 新增加一个pass专门给描边使用（描边pass在正常绘制pass之前）
        // 描边通道
        Pass
        {
